...
### a)
```{r}
The function below is an implementation of Metropolis-Hasting algorithm for hard-core model on a 100×100 grid, where the value of each grid is either 0 or 1. Among all the possible configurations, we want to sample from configurations that do not violate the hard-core restriction (no neighboring 1’s)
